...
class NonLinearEPKFRunner_fromFile:
    ...
    def run(self) -> None:
        ...
        if listeEPKF and listeEPKF[0][1] is not None:
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Filter non linear data with EPKF"
    )

    addParseToParser(
        parser,
        ['nonLinearModelName', 'dataFileName', 'ell']
    )
...
def main() -> None:
    ...
    runner = NonLinearEPKFRunner_fromFile(
