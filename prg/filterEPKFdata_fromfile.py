...
if __name__ == "__main__":
    ...
    USAGES:
        ...
        python3 prg/filterEPKFdata_fromfile.py --nonLinearModelName "x1_y1_withRetroactions" --dataFileName "testNL.csv" --verbose 0 --plot --saveHistory
    """
    ...
    epkf_2    = NonLinear_EPKF(param, verbose=verbose)
    ...
    if listeEPKF[0][1] is not None and plot:
