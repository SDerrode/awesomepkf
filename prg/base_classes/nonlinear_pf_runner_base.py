...
class NonLinearPFRunnerBase(ABC):
    """
    Base runner for NonLinear PF workflows.
    ...
    def __init__(
        ...
        self.pf: Optional[NonLinear_PF] = None
    ...
    def _compute_errors(self) -> None:
        ...
        self.pf.history.compute_errors(
            self.pf,
            ['xkp1'],
            ['Xkp1_update'],
            ['PXXkp1_update']
    ...
    def _save_history(self, filename: str) -> None:
        ...
        self.pf.history.save_pickle(filepath)
