...
if __name__ == "__main__":
    ...
    #  ['x1_y1_cubique', 'x1_y1_ext_saturant', 'x1_y1_gordon', 'x1_y1_sinus', 
    #      'x1_y1_withRetroactions', 'x2_y1', 'x2_y1_rapport', 
    #      'x2_y1_withRetroactions_augmented', 'x2_y1_withRetroactionsOfObservations']
